          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              {!fileName ? (
                ...
                <div className={`relative rounded-xl border p-4 flex flex-col items-center justify-center text-center space-y-2 ${
                  ...
                  <button
                    ...
                    className="mt-2 px-3 py-1 rounded bg-rose-600/80 hover:bg-rose-600 text-white text-xs font-medium transition"
                  >
                    Remove Payload
                  </button>
                </div>
