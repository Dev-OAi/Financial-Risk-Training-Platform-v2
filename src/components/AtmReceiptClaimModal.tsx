    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-xs p-4">
      <div className={`w-full max-w-3xl  border shadow-2xl overflow-hidden flex flex-col max-h-[90vh] ${
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
            ...
            <div className="space-y-4">
              ...
              {!previewUrl ? (
                ...
                <div className="relative  overflow-hidden border border-inherit bg-black/40 p-2 flex flex-col items-center">
                  <img src={previewUrl} alt="Receipt Preview" className="max-h-[220px] object-contain " />
                  <button
          ...
          {claimResult && (
            <div className="p-4  border bg-amber-500/10 border-amber-500/30 text-amber-400 flex items-center justify-between">
