...
export const EditStandardModal: React.FC<EditStandardModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className={`w-full max-w-3xl max-h-[92vh] flex flex-col  shadow-xl overflow-hidden border ${
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4 text-xs">
          ...
          <div className={`p-3.5  border space-y-2.5 ${
            ...
            <div className="flex items-center justify-between">
              ...
              <label className="cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5  bg-slate-700 hover:bg-slate-600 text-white font-medium text-xs shadow-xs transition">
            ...
            {sampleImageUrl && (
              <div className="relative mt-2  overflow-hidden border border-inherit bg-black/20 h-28 flex items-center justify-center">
                <img src={sampleImageUrl} alt="Reference Specimen" className="max-h-full max-w-full object-contain" />
                <button
                  type="button"
                  onClick={() => setSampleImageUrl('')}
                  className="absolute top-2 right-2 px-2 py-1  bg-rose-800/90 hover:bg-rose-700 text-white text-[10px] font-bold shadow transition"
                >
                  Remove
                </button>
              </div>
